...
class Analogy(Model):
    ...
    def predict(self, predict_h, predict_t, predict_r):
        ...
        return -tf.reduce_sum(self._calc_comp(predict_h_e1, predict_h_e2, predict_t_e1, predict_t_e2, predict_r_e1, predict_r_e2), 1, keepdims = True) - tf.reduce_sum(self._calc_dist(predict_h_e, predict_t_e, predict_rel), 1, keepdims = True)
